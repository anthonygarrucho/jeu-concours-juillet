...
// Static translation dictionary as requested by the user
const staticTranslations = {
  ...
  "es": {
    ...
    "submit_button": "Reclamar mis 10€ y participer en el sorteo de 1.000€",
...
export default function UploadForm() {
  ...
  // Dynamically resolve translation replacements inside the component body
  const translations = (() => {
    const formatted: any = {};
